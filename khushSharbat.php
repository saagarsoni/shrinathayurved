...
<form action="manage_cart.php" method="post" class="product p-2">
   ...
   <div class="container">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/khush1.jpg" class=" w-100 img-fluid" alt="Lemon Squash"style="height: 400px;">
            </div>
    ...
    <input type="hidden" name="price" value="1">
         ...
         <div class="col-lg-6">
            <div class="w-100 fs-6 bg-warning p-1 fw-bold fs-4 rounded text-center">Khush Sharbat</div>
               <p id="khasDetail" class="text-sm-start lh-sm"></p>
         </div>
      </div>
   </div>
</form>
<script>
   //Lemon Squash
      $("#khasDetail").load("./text/khasDetail.txt");
</script>