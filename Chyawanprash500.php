...
<form action="manage_cart.php" method="post" class="product p-2">
   ...
   <div class="container">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/Chyawanprash500.jpg" class=" w-100 img-fluid" alt="Lemon Squash"style="height: 450px;">
            </div>
    ...
    <button type="submit" name="addToCart" style="width: 100%;" class="btn bg-success text-light fw-bold">Add To Cart <i
         ...
         <div class="col-lg-6">
            <div class="w-100 fs-6 bg-warning p-1 fw-bold fs-4 rounded text-center">Chyawanprash 500 gm</div>
