...
<form action="manage_cart.php" method="post" class="product p-2">
   ...
   <div class="container">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/orangeSquash1.jpg" class=" w-100 img-fluid" alt="Lemon Squash"style="height: 400px;">
            </div>
            <div class="carousel-item">
                <img src="./images/orangeSquash2.jpg" class=" w-100 img-fluid" alt="Lemon Squash"  style="height: 450px;">
            </div>
            <!-- <div class="carousel-item">
    ...
    <input type="hidden" name="price" value="1">
         ...
         <div class="col-lg-6">
            <div class="w-100 fs-6 bg-warning p-1 fw-bold fs-4 rounded text-center">Orange Squash</div>
